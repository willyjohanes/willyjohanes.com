...
@section('container')
    <h1 class="mb-3 text-center fs-2">{{ $title }}</h1>

    <div class="row mb-3 justify-content-center">
        <div class="col-md-6">
            <form action="/biblestudy">
                @if (request('category'))
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <p>
                    <small class="text-muted"> By: <a href="/biblestudy?author={{ $posts[0]->author->username }}"
                            class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a
                            href="/biblestudy?category={{ $posts[0]->category->slug }}"
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="position-absolute px-3 py-2" style="background-color:rgba(0,0,0,0.7)"><a
                                    href="/biblestudy?category={{ $post->category->slug }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        <small class="text-muted"> By: <a
                                                href="/biblestudy?author={{ $post->author->username }}"
